...
#include "backend/Conv2dLibxsmm.h"
#include "backend/Conv2dReluLibxsmm.h"
...
int main() {
   ...
   * Conv2dLibxsmm
   */
  MINI_DNN_LOG_INFO << "benchmarking Conv2dLibxsmm.." << std::endl;
  mini_dnn::backend::Conv2dLibxsmm l_conv2d_libxsmm;
   ...
   * Conv2dReluLibxsmm
   */
  MINI_DNN_LOG_INFO << "benchmarking Conv2dReluLibxsmm.." << std::endl;
  mini_dnn::backend::Conv2dReluLibxsmm l_conv2d_relu_libxsmm;

  std::tie( l_n_repetitions,
            l_time,
            l_gflops ) = benchConv2d( l_input,
                                      l_weight,
                                      l_conv2d_relu_libxsmm );
