...
#ifndef MINI_DNN_BACKEND_CONV2D_RELU_LIBXSMM_H
#define MINI_DNN_BACKEND_CONV2D_RELU_LIBXSMM_H
...
class mini_dnn::backend::Conv2dReluLibxsmm: public Conv2d {
  private:
  public:
    /**
