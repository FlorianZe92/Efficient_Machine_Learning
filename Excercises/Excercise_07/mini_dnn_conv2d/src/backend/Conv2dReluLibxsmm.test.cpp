...
TEST_CASE( "Tests the convolution forward operator through LIBXSMM calls and the use of Relu.",
           "[convolution][libxsmm][Relu]][forward]" ) {
  ...
  // compute solution
  mini_dnn::backend::Conv2dReluLibxsmm l_conv2d;
